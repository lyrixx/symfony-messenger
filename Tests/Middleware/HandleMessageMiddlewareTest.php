...
class HandleMessageMiddlewareWithAckConfigurationTestCallable implements ConfigureAutoAckInterface
{
    private $disableAutoAck;

    public function __construct(bool $disableAutoAck)
    {
        $this->disableAutoAck = $disableAutoAck;
    }

    public function disableAutoAck(Envelope $envelope): bool
    {
        return $this->disableAutoAck;
    }
